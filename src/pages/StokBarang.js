...
const StokBarang = () => {
    ...
    const fetchStok = useCallback(async () => {
        try {
            ...
            // URL disesuaikan dengan prefix 'admin' di api.php Laravel
    ...
    const handleTambahStok = async (id, namaModel) => {
        ...
        try {
            const config = { headers: { Authorization: `Bearer ${token}` } };
            // Menggunakan method PUT sesuai dengan route di Laravel: /admin/motors/{id}/tambah-stok
        ...
        <div style={pageContainer}>
            <div style={contentWrapper}>
                ...
                <motion.div 
                    ...
                    style={headerSection}
                >
                    <button onClick={() => navigate('/beranda')} style={btnBack}>← Back</button>
                    <div>
                                            ...
                                            >
                                                ...
                                                <td style={tdStyle}>
                                                    <div style={{ display: 'flex', alignItems: 'center' }}>
                                                        <span style={stokBadge(motor.stok)}>
                                                            {motor.stok} UNIT
                                                        </span>
...
const btnBack = { 
    ...
    color: '#fff', padding: '10px 18px', borderRadius: '10px', cursor: 'pointer', fontSize: '13px', fontWeight: '600'
};
